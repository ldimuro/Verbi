      ...
      _createClass(AppComponent, [{
        ...
        value: function tutorialModal(open) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
            var tutorial_modal, _tutorial_modal;
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    tutorial_modal = document.getElementById('tutorial_modal');
                  ...
                  case 10:
                    ...
                    _tutorial_modal = document.getElementById('tutorial_modal');

                    _tutorial_modal.classList.remove('modal_fadein');

                    _tutorial_modal.classList.remove('modal_appear');

                    _tutorial_modal.classList.add('modal_fadeout'); // Give time for blur_out animation to perform
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    document.getElementById("app").classList.add('blur-background_in');
                    document.getElementById("app").classList.remove('blur-background_out');
                    stats_modal = document.getElementById('stats_modal');
                  ...
                  case 10:
                    document.getElementById("app").classList.remove('blur-background_in');
                    document.getElementById("app").classList.add('blur-background_out');
                    _stats_modal = document.getElementById('stats_modal');

                    _stats_modal.classList.remove('modal_fadein');

                    _stats_modal.classList.remove('modal_appear');

                    _stats_modal.classList.add('modal_fadeout'); // Give time for blur_out animation to perform
        ...
        value: function contactModal(open) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
            var contact_modal, _contact_modal;
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    ...
                    document.getElementById("app").classList.add('blur-background_in');
                    document.getElementById("app").classList.remove('blur-background_out');
                    contact_modal = document.getElementById('contact_modal');
                  ...
                  case 10:
                    document.getElementById("app").classList.remove('blur-background_in');
                    document.getElementById("app").classList.add('blur-background_out');
                    _contact_modal = document.getElementById('contact_modal');

                    _contact_modal.classList.remove('modal_fadein');

                    _contact_modal.classList.remove('modal_appear');

                    _contact_modal.classList.add('modal_fadeout'); // Give time for blur_out animation to perform
        ...
        value: function wordsModal(open) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
            var words_modal, _words_modal, word_list;
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    document.getElementById("app").classList.add('blur-background_in');
                    document.getElementById("app").classList.remove('blur-background_out');
                    words_modal = document.getElementById('words_modal');
                  ...
                  case 10:
                    document.getElementById("app").classList.remove('blur-background_in');
                    document.getElementById("app").classList.add('blur-background_out');
                    _words_modal = document.getElementById('words_modal');

                    _words_modal.classList.remove('modal_fadein');

                    _words_modal.classList.remove('modal_appear');

                    _words_modal.classList.add('modal_fadeout'); // Give time for blur_out animation to perform
        ...
        value: function giveUpModal(open, give_up) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
            var giveup_modal, _giveup_modal, word_list, i;
              ...
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    document.getElementById("app").classList.add('blur-background_in');
                    document.getElementById("app").classList.remove('blur-background_out');
                    giveup_modal = document.getElementById('giveup_modal');
                  ...
                  case 10:
                    document.getElementById("app").classList.remove('blur-background_in');
                    document.getElementById("app").classList.add('blur-background_out');
                    _giveup_modal = document.getElementById('giveup_modal');

                    _giveup_modal.classList.remove('modal_fadein');

                    _giveup_modal.classList.remove('modal_appear');

                    _giveup_modal.classList.add('modal_fadeout'); // Give time for blur_out animation to perform
